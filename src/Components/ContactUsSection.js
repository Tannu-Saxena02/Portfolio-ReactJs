...
export default function ContactUsSection() {
  return (
    ...
    {/* <div className="textContact" style={{flexDirection:"row",display:"flex"}}></div> */}
    ...
    <div className="formContainer">
      <div className="contactText">
        ...
        <div className="contactRoleText">
          I am a Mobile Developer/Frontened Developer can create
          interactive, bold and userfriendly design
        </div>
        ...
        <div className="socialMediaIcon">
          <a href="https://www.instagram.com/fajuks/" target="_blank" rel="noreferrer">
            <AiFillFacebook
              onMouseOver={({ target }) =>
                (target.style.color = "#05B4FF")
              }
